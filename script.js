...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const personagens = [
    ...
    },
    {
      ...
      descricao: "Miranda, a diva amargurada."
    }
  ];
  ...
  function sortearPersonagem() {
    ...
    resultado.innerHTML = `
      ...
      <button id="naoEntendiBtn">NÃO ENTENDI</button>
    `;

    // Seleciona o novo botão após ele ser adicionado
    const naoEntendiBtn = document.getElementById("naoEntendiBtn");
    naoEntendiBtn.addEventListener("click", function() {
      window.location.href = "site.html"; // Redireciona para site.html
    });
  }
